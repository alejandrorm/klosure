...
class AndExpression(val expression1: Expression, val expression2: Expression) : Expression {
    override fun eval(solution: SolutionMapping): Node? {
        ...
        if (v1 == null && v2 == FalseLiteral) return FalseLiteral
        if (v2 == null && v1 == FalseLiteral) return FalseLiteral
        if (v1 == null && v2 == TrueLiteral) return null
        if (v2 == null && v1 == TrueLiteral) return null
