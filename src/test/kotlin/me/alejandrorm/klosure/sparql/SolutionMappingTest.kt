...
class SolutionMappingTest {
    ...
    fun testFreeVariablesAfterBinding() {
        ...
        Assertions.assertEquals(mapOf(v2 to n2.id, v4 to n4.id), solutionMapping.boundVariables)
    }
    ...
    fun testBinding() {
        ...
        val solutionMapping1 = solutionMapping0.bind(v1, n1.id)
        val solutionMapping2 = solutionMapping1.bind(v2, n2.id)
        val solutionMapping3 = solutionMapping2.bind(v3, n3.id)
        val solutionMapping4 = solutionMapping3.bind(v4, n4.id)
        ...
        Assertions.assertEquals(emptyMap<Variable, NodeId>(), solutionMapping0.boundVariables)
        ...
        Assertions.assertEquals(mapOf(v1 to n1.id), solutionMapping1.boundVariables)
        ...
        Assertions.assertEquals(mapOf(v1 to n1.id, v2 to n2.id), solutionMapping2.boundVariables)
        ...
        Assertions.assertEquals(mapOf(v1 to n1.id, v2 to n2.id, v3 to n3.id), solutionMapping3.boundVariables)
        ...
        Assertions.assertEquals(mapOf(v1 to n1.id, v2 to n2.id, v3 to n3.id, v4 to n4.id), solutionMapping4.boundVariables)
    }
}
